...
func TestNewUser(t *testing.T) {
	user, err := entities.NewUser("Antônio Prado", "antonio@antonioeprado.dev")
	if err != nil {
...
func TestNewUser_MissingName(t *testing.T) {
	if _, err := entities.NewUser("", "antonio@antonioeprado.dev"); !errors.Is(err, entities.ErrNameRequired) {
		t.Fatalf("expected ErrNameRequired, got %v", err)
	}
}

func TestNewUser_MissingEmail(t *testing.T) {
	if _, err := entities.NewUser("Antônio Prado", ""); !errors.Is(err, entities.ErrEmailRequired) {
...
func TestUser_Update_MissingName(t *testing.T) {
	...
	if _, err := user.Update("", "antonio@antonioeprado.dev"); !errors.Is(err, entities.ErrNameRequired) {
		t.Fatalf("expected ErrNameRequired, got %v", err)
	}
}
...
func TestUser_Update_MissingEmail(t *testing.T) {
	...
	if _, err := user.Update("Antônio Prado", ""); !errors.Is(err, entities.ErrEmailRequired) {
		t.Fatalf("expected ErrEmailRequired, got %v", err)
	}
}
